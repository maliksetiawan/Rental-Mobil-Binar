            ...
            <div className="card p-4 mb-3">
              ...
              <div>
                <div className="d-flex py-3 mb-2">
                  <p className="m-0 py-2 d-flex justify-content-center align-items-center card" style={{ width: "85px" }}>
                    BCA
                  </p>
                ...
                <div>
                  <form>
                    ...
                    <div className="d-flex">
                      <input disabled value={formatterRupiah(state.total_price)} id="rekening" className="w-100 px-2 py-1"></input>
                      <button
                        className="px-3 btn btn-light"
                        onClick={(e) => {
            ...
            <div className="card p-4">
              ...
              <div className="d-flex my-4 row px-3">
                <p
                  ...
                  style={paymentMethod === "ATM BCA" ? { borderBottom: "solid 2px green" } : { borderBottom: "solid 2px #EEEEEE", cursor: "pointer" }}
                >
                  ATM BCA
                </p>
                <p
                  ...
                  style={paymentMethod === "M-BCA" ? { borderBottom: "solid 2px green" } : { borderBottom: "solid 2px #EEEEEE", cursor: "pointer" }}
                >
                  M-BCA
                </p>
                <p
                  ...
                  style={paymentMethod === "BCA Klik" ? { borderBottom: "solid 2px green" } : { borderBottom: "solid 2px #EEEEEE", cursor: "pointer" }}
                >
                  BCA Klik
                </p>
                <p
                  ...
                  style={paymentMethod === "Mobile Banking" ? { borderBottom: "solid 2px green" } : { borderBottom: "solid 2px #EEEEEE", cursor: "pointer" }}
                >
                  Mobile Banking
                </p>
              </div>
          ...
          <div className="col-lg-4 p-0">
            {!uploadPaymentProof ? (
              <div className="card p-4">
                ...
                <div>
                  <button className="btn btn-success w-100" onClick={() => setUploadPaymentProof(true)}>
              ...
              <div className="card p-4">
                ...
                <div>
                  <button className="btn btn-success w-100 mt-3" onClick={() => navigate(`/car/etiket/`)}>
                    Upload
                  </button>
                </div>
              </div>
