...
export const postOrder = createAsyncThunk("customer/order", async ({ start_rent_at, finish_rent_at, car_id }, thunkAPI) => {
  try {
...
export const getOrder = createAsyncThunk("customer/getOrder", async ({ id }, thunkAPI) => {
  try {
...
export const uploadSlip = createAsyncThunk("customer/uploadSlip", async ({ id }, thunkAPI) => {
  try {
...
export const deleteOrder = createAsyncThunk("customer/deleteOrder", async ({ id }, thunkAPI) => {
  try {
...
export const listOrder = createAsyncThunk("customer/listOrder", async ({ id }, thunkAPI) => {
  try {
